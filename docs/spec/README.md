...
| [Evidence / Trace / 授权下载](2026-09-12-evidence-trace.md) | 草案（2026-09-12）：P6 其余部分。`evidenceStatus` 与执行结论分两根轴、证据债务先登记后上传并有界补传、崩溃只补账不补字节、授权下载与 Evidence Viewer、Trace 按 Attempt 分 chunk 失败保留、写入前脱敏不猜字段名、按类型与结局保留、S04。不含 SSE / `run_events`（P7）、AI 证据（P8 / P9） | — |
