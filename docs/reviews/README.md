...
| 日期 | 报告 | 对应方案 | 状态 |
| --- | --- | --- | --- |
| 2026-09-15 | [FlowGram 蛇形排布与工作区留白修正](2026-09-15-flowgram-snake-layout.md) | [接入方案](../spec/2026-09-14-flowgram-sequence-editor.md) | 同字号下可见节点由 4 到 8；空列修正，14 组浏览器交互及 43 项定向测试通过；已按用户授权合入 main；完整类型检查的既有阻断见报告 |
